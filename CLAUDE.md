...
- **最高規範**：`.specify/memory/constitution.md`（憲章，v1.0.1，2026-07-19 依 spec §4 的 17 條
...
- **`/speckit-constitution` 已於第一個 Feature 之前執行**（2026-07-19），spec §4 的 17 條原則
  已寫進 `.specify/memory/constitution.md`（現行 v1.0.1，v1.0.1 為 Gemini 型號釘死的 PATCH 修訂）；
  後續修訂依憲章 Governance 章節的程序。
